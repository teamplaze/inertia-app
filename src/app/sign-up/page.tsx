  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setErrors({ general: `Sign-up failed: ${data.details || data.error || 'Please try again.'}` });
        setIsLoading(false);
      }
    } catch (error) {
      console.error(error);
  ...
  return (
    <AuthCard>
      ...
      <div className="flex flex-col gap-[var(--spacing-2)]">
        ...
        >
          {inviteToken ? 'Artist Access' : 'Create an account'}
        </h1>
        <p
          className={cn(
      ...
      >
          ...
          <div className="flex items-start gap-[var(--spacing-3)]">
            ...
            >
              ...
              <button
                ...
                className="underline text-white hover:text-[var(--color-bg-teal)] transition-colors duration-150"
              >
                Terms & Conditions
              </button>
            </label>
        ...
        {message && (
          <p className="font-body font-normal text-[14px] text-white text-center">
            {message}
          </p>
        )}
      </form>
        ...
        >
          ...
          >
            ...
            <p>
              ...
              <br/>iv. Any unsolicited or unauthorized advertising, promotional materials, &ldquo;junk mail,&rdquo; &ldquo;spam,&rdquo; &ldquo;chain letter,&rdquo; &ldquo;pyramid scheme&rdquo; or investment opportunity, or any other form of solicitation.
              ...
              <br/>m) Use any robot, spider, Website search/retrieval application or other manual or automatic device to retrieve, index, &ldquo;scrape,&rdquo; &ldquo;data mine&rdquo; or in any way reproduce or circumvent the navigational structure or presentation of the Website, without our express prior, written consent.
              <br/><br/>
